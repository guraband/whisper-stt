...
# 테스트 문장
origin_sentence = "Hello, how are you?"
compare_sentences = [
    "Hello, how are you?",
    "Hello how are you",
    "Hello how        are you",
    "Hello how are you do in?",
    "Hello how are you doing?"
]

print(f"원본 문장: {origin_sentence}")
for i, sentence in enumerate(compare_sentences):
    similarity_score = calculate_similarity(origin_sentence, sentence)
    print(f"유사도 {i+1}: {similarity_score * 100:.2f}%")
